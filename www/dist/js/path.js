...
function nextStep(pathJSON, PathLength)
{
	...
	+ ',"start":' + '{"latitude":"' + (new Number(StartPoint.A)).toFixed(14) + '","longitude":"' + (new Number(StartPoint.F)).toFixed(14) + '"}' 
	+ ',"end":' + '{"latitude":"' + (new Number(pathTemp[pathTemp.length - 1].A)).toFixed(14) + '","longitude":"' + (new Number(pathTemp[pathTemp.length - 1].F)).toFixed(14) + '"}}';
